...
%		}
  ...
  \section{Method}
    ...
    \subsection{Basis}
      ...
      %Review [Loan] : aucune mention de la "Path constraints" ? Si je ne me trompe pas, c'est l'ensemble de toutes les path conditions de l'état courant (dont tu parle tout les 2). 
    \subsection{Problems}
      \label{sec:problems}
