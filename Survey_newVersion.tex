...
and side effects.
    	...
    	\label{subsec:S2EExample}
			...
			%TODO [LOAN] : meilleur exemple, en raccourcissant la section précédente et mieux détailler les transitions dans cet exemple. S'inspirer de la section 2.2 (et la figure 2) du document \cite{chipounov2012s2e}.
